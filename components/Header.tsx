...
export const Header: React.FC<HeaderProps> = ({ theme, presets, activeView, onSetView, onToggleTheme, onLoadPreset, onSavePreset, onRandomize, onClear, onOpenCommandPalette, onToggleLogPanel }) => {
  ...
  const inactiveTabStyles = "text-bunker-500 dark:text-bunker-400 hover:bg-bunker-200 dark:hover:bg-bunker-700";
  ...
  return (
    <header className="bg-bunker-50 dark:bg-bunker-900 text-bunker-900 dark:text-white p-3 flex items-center justify-between border-b border-bunker-200 dark:border-bunker-800 shadow-md shrink-0">
      <div className="flex items-center space-x-6">
          ...
          <nav className="flex items-center space-x-2 p-1 bg-bunker-100 dark:bg-bunker-800 rounded-lg">
