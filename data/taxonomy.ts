...
export const starterTaxonomy: Taxonomy = [
  {
    ...
    tags: [
      ...
      { id: 'g_house', label: 'House', description: 'Electronic dance music characterized by a 4/4 time signature, typically around 120-130 BPM.', suggests: ['g_electronic', 't_fourfloor'], color: 'green' },
      { id: 'g_deep_house', label: 'Deep House', description: 'A slower, more soulful variant of house music with complex melodies and mellow vibes. Examples: "Finally" by Kings of Tomorrow, "The Cure & The Cause" by Fish Go Deep.', suggests: ['g_house'], color: 'green' },
      { id: 'g_slap_house', label: 'Slap House', description: 'A modern, bass-driven subgenre of house music known for its punchy, "slapping" basslines and often featuring pop vocal covers. Examples: "Breaking Me" by Topic & A7S, "Your Love (9PM)" by ATB, Topic, A7S.', suggests: ['g_house'], color: 'green' },
      ...
      // Pop
      { id: 'g_synthpop', label: 'Synthpop', description: 'Pop music where the synthesizer is the dominant musical instrument. Examples: The Human League, Pet Shop Boys.', suggests: ['g_electronic'], color: 'pink' },
      ...
      { id: 'g_ambient_pop', label: 'Ambient Pop', description: 'Pop music that incorporates textures and atmospheres from ambient music. Examples: Cocteau Twins, M83.', suggests: ['g_ambient'], color: 'pink' },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'm_ethereal', label: 'Ethereal', description: 'Extremely delicate, light, and seemingly not of this world.', suggests: ['m_bittersweet'], color: 'purple' },
  ...
  },
  {
    ...
    tags: [
      ...
      // Melody Development
      { id: 'hm_evolving_melody', label: 'Evolving Melody', description: 'A melody that changes and develops over the course of the track. Example: "Bohemian Rhapsody" by Queen.', suggests: ['hm_melodic_transitions', 'st_dynamic_shifts'], color: 'blue' },
      ...
      { id: 'hm_variative', label: 'Variative', description: 'Features significant variation and change in melodies, rhythms, or textures throughout the track. Promotes novelty over repetition.', suggests: ['hm_evolving_melody'], color: 'blue' },
      { id: 'hm_transformative', label: 'Transformative', description: 'The track undergoes a fundamental shift or transformation in its character or genre. A more extreme version of "variative".', suggests: ['hm_variative'], color: 'blue' },
      { id: 'hm_modular', label: 'Modular', description: 'Music constructed from repeating and evolving short melodic or rhythmic cells, similar to the style of Mike Oldfield.', color: 'blue' },
      // Harmony
      ...
      { id: 'hm_phrase_extension', label: 'Phrase Extension', description: 'A technique where a musical phrase is elongated or developed beyond its expected length.', suggests: ['hm_countermelodies'], color: 'gray' },
      { id: 'hm_modulation', label: 'Modulation', description: 'The act of changing from one key (tonic, or tonal center) to another.', color: 'gray' },
      // Embellishments
      { id: 'hm_embellishments', label: 'Embellishments', description: 'Ornamental notes that add decoration to a melody.', color: 'purple' },
      { id: 'hm_harmonic_embellishment', label: 'Harmonic Embellishment', description: 'Adding notes to chords to make the harmony more complex and interesting.', suggests: ['hm_embellishments'], color: 'purple' },
      { id: 'hm_melodic_embellishment', label: 'Melodic Embellishment', description: 'Adding decorative notes like trills and turns to a melody line.', suggests: ['hm_embellishments'], color: 'purple' },
      // Other
      ...
      { id: 'hm_ornamental_piano_solo', label: 'Ornamental Piano Solo', description: 'A decorative and elaborate piano solo.', suggests: ['i_piano'], color: 'yellow' },
    ],
  },
  {
    id: 'structure',
    ...
    tags: [
      ...
      { id: 's_breakdown', label: 'Breakdown', description: 'A sparse section where rhythmic elements are removed.', suggests: ['s_risers', 's_crescendos'] },
  ...
  },
   {
    ...
    tags: [
      ...
      { id: 'st_warm', label: 'Warm', description: 'A sound texture that is pleasant, rich, and often associated with analog equipment.', suggests: ['m_warm'], color: 'orange' },
      { id: 'st_smooth', label: 'Smooth', description: 'A sound texture that is flowing, connected, and without harshness.', color: 'orange' },
      { id: 'st_ambient', label: 'Ambient', description: 'A texture that creates an atmospheric, surrounding soundscape.', suggests: ['g_ambient'], color: 'green' },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'i_orchestra', label: 'Orchestra', description: 'A large ensemble of classical instruments.', suggests: ['i_strings', 'i_brass_section', 'i_woodwinds'], color: 'indigo' },
      // Percussive & FX
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'p_wet_mix', label: 'Wet Mix', description: 'Heavy use of effects like reverb and delay.', conflictsWith: ['p_dry_mix'], suggests: ['p_ambient_reverb'], color: 'blue' },
  ...
  },
  {
    ...
    name: 'Use-case',
    tags: [
        { id: 'u_chilling', label: 'Music for chilling and falling asleep', description: 'Designed for relaxation and sleep.', suggests: ['m_chill', 'm_relaxing'], color: 'gray' },
        { id: 'u_studying', label: 'Music for studying', description: 'Background music that aids concentration.', suggests: ['m_calm'], color: 'gray' },
        { id: 'u_workout', label: 'Workout music', description: 'High-energy music for exercise.', suggests: ['m_energetic', 't_high_tempo'], color: 'gray' },
        { id: 'u_driving', label: 'Driving music', description: 'Music suitable for listening to while driving.', suggests: ['m_driving'], color: 'gray' },
        { id: 'u_background', label: 'Background music', description: 'Unobtrusive music that can be played in the background.', color: 'gray' },
        { id: 'u_dj_set', label: 'DJ set', description: 'Suitable for inclusion in a DJ mix.', suggests: ['s_djfriendly'], color: 'gray' },
        { id: 'u_dancefloor', label: 'Dancefloor', description: 'High-energy, designed for dancing in a club.', suggests: ['m_energetic', 't_high_tempo'], color: 'gray' },
    ],
  },
  {
    id: 'lyrics',
